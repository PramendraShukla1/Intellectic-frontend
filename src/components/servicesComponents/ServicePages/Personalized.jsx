  ...
  <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
    ...
    <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
      ...
      <div>
        ...
        Discover the Power of Personalized Websites: Your Online Identity, Tailored to Perfection. Our Personalized Websites Service Puts You in the Driver's Seat of Your Online Presence. With a Blend of Innovative Design and User-Centric Functionality, We Craft Websites that Mirror Your Brand's Uniqueness. From Customizable Layouts to Interactive Features, Every Element is Aligned with Your Vision. We Understand that Your Website is More Than Just Code - It's Your Story, Your Vision, Your Connection to the World. Join Us in Creating an Online Destination that Reflects You and Resonates with Your Audience. Elevate Your Digital Presence with Personalization at its Finest.
        </p>
        <p className="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">
         Service Code: pn8D4sjLVGYSIP9
        </p>
