...
import webdev from "../../../assets/resume.png"
...
const ResumeBuilding = () => {
  ...
  return (
      <div className="bg-white bg-center h-screen">
  ...
  <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
    ...
    <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
      ...
      <div>
        ...
        Unlock Your Professional Potential with Our Resume Building Service. Your Career Journey Begins with a Strong Foundation – Your Resume. Our Expertise Lies in Crafting Resumes that Shine a Spotlight on Your Skills, Accomplishments, and Aspirations. We Understand that Your Resume is Your Personal Brand, Your Passport to Opportunities. With Tailored Content and Eye-Catching Designs, We Transform Your Professional Story into a Compelling Narrative. Whether You're Entering the Job Market, Switching Careers, or Aiming for Advancement, We're Your Partners in Creating a Resume that Opens Doors. Let Us Help You Secure Your Next Adventure with a Resume that Leaves a Lasting Impression.
        </p>
        <p className="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">
         Service Code: kOOMTDc0fET1v5u
        </p>
        <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">
        Delivery: Delivery will be in three phases <br /><br />
        Phase 1 - First Prototype will be shared with client. <br /><br />
        Phase 2 - Client can check the prototype and provide feedback.<br/><br />
        Phase 3 - Final resume will be deliverd to customer
        </p>
        <p className="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">
