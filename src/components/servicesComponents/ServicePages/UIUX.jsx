...
import webdev from "../../../assets/ui.png"
  ...
  <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
    ...
    <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
      ...
      <div>
        ...
        Elevate User Experiences with Our UI/UX Design Service. Your Digital Platform Deserves Intuitive Design that Engages and Delights. Our Expert Designers Craft Interfaces that Seamlessly Merge Beauty and Functionality. We Understand the Importance of User-Centered Design in Creating Lasting Impressions. From Wireframes to Prototypes, We Bring Your Vision to Life with Precision and Creativity. Whether You're Launching a Website or Mobile App, We're Your Partners in Building Interfaces that Connect Emotionally and Deliver Value. Let Us Transform Your Ideas into Engaging Digital Experiences that Keep Users Coming Back for More.
        </p>
        <p className="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">
         Service Code: eJ67i8n9oG2fhjy
        </p>
