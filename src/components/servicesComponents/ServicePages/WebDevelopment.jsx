...
import webdev from "../../../assets/website.png"
  ...
  <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
    ...
    <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
      ...
      <div>
        ...
        Elevate Your Digital Presence with our Web Development and Design Services. From Concept to Creation, we Craft Engaging and Responsive Websites that Showcase Your Brand's Identity. Our Expert Team Seamlessly Blends Design Aesthetics with Cutting-Edge Technology to Deliver Visually Stunning and High-Performance Websites. Whether You're Launching a New Online Venture or Enhancing Your Current Site, We're Your Partners in Transforming Ideas into Captivating Online Experiences. Let Us Shape Your Digital Footprint and Create a Platform that Leaves a Lasting Impression.
        </p>
        <p className="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">
         Service Code: DZSp08Ida5b5wBt
        </p>
