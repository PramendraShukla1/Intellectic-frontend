      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Empowering Understanding through Answers: Navigating Your Queries, Providing Solutions.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Welcome to our FAQ page! We've compiled a list of common questions to provide you with quick answers and solutions. If you don't find the information you're looking for, feel free to contact us for further assistance.
            </p>
