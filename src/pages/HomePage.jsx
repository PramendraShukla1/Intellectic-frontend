...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-white backgroundImg">
        <header className="absolute inset-x-0 top-0 z-50">
          <nav
            className="flex items-center justify-between p-6 lg:px-6 h-8"
            aria-label="Global"
          >
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl ">
                ...
                <span className="text-cyan-800">Intellectic</span> - Where
                Dreams Transform into Reality!
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Fueling innovation, one line of code at a time – our startup is
      ...
      {/* About Component Section Starts Here    */}
      <AboutComponent />
      {/* About Component Section Ends Here     */}

      {/* Contact Us Component Section Starts Here    */}
      <ContactUs />
      {/* Contactus Component Section Starts Here    */}

      {/* Footer Component Section Starts Here    */}
      <Footer />
      {/* Footer Component Section Ends Here    */}
    </div>
  );
};
