      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Ensuring Authenticity: Your Trusted Source for Certification Verification.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Certification Verification: Elevating Trust through Verified Credentials. Confirm the Validity of Achievements with Confidence.
            </p>
